...
const DescubreTuArquetipo10 = () => {
  const pdfUrl = "/src/pdfs/guiaArcanoLaRueda10-vg.pdf";
  ...
  return (
    <Flex direction="column" minH="100vh">
      ...
      <Text
        ...
        color={"white"}
      >
        La Rueda De La Fortuna - Descubre tu arquetipo
      </Text>
...
export default DescubreTuArquetipo10;
