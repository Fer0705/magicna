...
const DescubreTuArquetipo2 = () => {
  const pdfUrl = "/src/pdfs/guiaArcanoLaSacerdotisa2-vg.pdf";
  ...
  return (
    <Flex direction="column" minH="100vh">
      ...
      <Text
        ...
        color={"white"}
      >
        La Sacerdotisa - Descubre tu arquetipo
      </Text>
...
export default DescubreTuArquetipo2;
